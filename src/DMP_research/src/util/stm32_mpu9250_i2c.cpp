...
static uint8_t wait_for_gpio_state_timeout(GPIO_TypeDef* port, uint16_t pin, int state, uint32_t timeout)
{
  //uint32_t Tickstart = time_service::getCurTime();
//    uint8_t ret = 1;
...
static void I2C_ClearBusyFlagErratum(int handle, uint32_t timeout)
{
